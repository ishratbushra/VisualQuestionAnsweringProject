...
This project implements a Visual Question Answering (VQA) system that combines multi-modal features — scene understanding, object detection, question embedding, and captioning — to answer natural language questions about images using deep learning techniques.
